...
// 初始化book table的数据, 3类书
    String initBookData1 =
            "insert into book \n" +
                    "values\n" +
                    "(100, 0, '历史', 0, '', '', ''),\n" +
                    "(1, 0, '人类简史：从动物到上帝', 23.3, 'love', '尤瓦尔·赫拉利', '用不太, 助教团队几乎不存在有效的方法来禁止大家耍这些小聪明. 其实, 这更多是需要大家发自内心去认可和执行的: 当你搜到了一些所谓攻略的时候, 你心里应该想到\"阅读它们会降低训练的效果\", 然后你主动拒绝它们的诱惑, 坚持自己独立完成实验内容. 这和大家自觉遵守学术诚信是很类似的: 你心里清楚考试作弊是不对的, 然后, 助教团队几乎不存在有效的方法来禁止大家耍这些小聪明. 其实, 这更多是需要大家发自内心去认可和执行的: 当你搜到了一些所谓攻略的时候, 你心里应该想到\"阅读它们会降低训练的效果\", 然后你主动拒绝它们的诱惑, 坚持自己独立完成实验内容. 这和大家自觉遵守学术诚信是很类似的: 你心里清楚考试作弊是不对的, 然后, 助教团队几乎不存在有效的方法来禁止大家耍这些小聪明. 其实, 这更多是需要大家发自内心去认可和执行的: 当你搜到了一些所谓攻略的时候, 你心里应该想到\"阅读它们会降低训练的效果\", 然后你主动拒绝它们的诱惑, 坚持自己独立完成实验内容. 这和大家自觉遵守学术诚信是很类似的: 你心里清楚考试作弊是不对的, 然后, 助教团队几乎不存在有效的方法来禁止大家耍这些小聪明. 其实, 这更多是需要大家发自内心去认可和执行的: 当你搜到了一些所谓攻略的时候, 你心里应该想到\"阅读它们会降低训练的效果\", 然后你主动拒绝它们的诱惑, 坚持自己独立完成实验内容. 这和大家自觉遵守学术诚信是很类似的: 你心里清楚考试作弊是不对的, 然后长的文字，讲述了主人公福贵五十年'),\n" +
